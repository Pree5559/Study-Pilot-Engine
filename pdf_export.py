...
def build_legend(S):
    items = [
        (RED_BG, RED_ACCENT, "Exam week", "7 days left"),
        (YEL_BG, YEL_ACCENT, "Revision", "14 days left"),
...
def build_timetable_table(rows, S):
    col_w = [
        26 * mm,  # Date
        42 * mm,  # Subject
        TABLE_W - 26 * mm - 42 * mm - 18 * mm - 20 * mm,  # Topics (remaining width)
        18 * mm,  # Time
        20 * mm,  # Notes
    ]
...
#     rows,
#     summary=summary,
#     output_path="mytimetable.pdf",
# )
# send_daily_nudge(rows, os.getenv("RECEIVER_EMAIL"))